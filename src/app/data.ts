...
export const wordSets: Record<string, WordSet[]> = {
  ...
  practical: [
    ...
    { words: ["ランニング", "筋トレ", "ヨガ", "サイクリング"], correctAnswer: "健康維持のための運動" },
    { words: ["テレワーク", "オンライン会議", "クラウドストレージ", "チャットツール"], correctAnswer: "リモートワークの必須アイテム" },
    { words: ["レジ袋", "マイバッグ", "紙ストロー", "エコボトル"], correctAnswer: "環境に配慮した生活用品" },
    { words: ["マスク", "消毒液", "検温", "ソーシャルディスタンス"], correctAnswer: "コロナ禍で日常になったもの" },
    { words: ["レシピ動画", "オンライン料理教室", "食材宅配", "ミールキット"], correctAnswer: "自宅料理のサポートサービス" }
  ]
};
